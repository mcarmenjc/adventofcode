...
function partOne(){
    ...
    console.log("Example 1 => " + calculateFrequency(example1));
...
function partTwo(){
    ...
    console.log("Example 1 => " + getRepeatedFrequency(example1));
    console.log("Example 2 => " + getRepeatedFrequency(example2));
